...
class DoccumentChat:
    """
    Classe pour gérer les interactions avec un documents et un modèle de langage.
    ...
    load_doc_in_es(doc_path, index_name): Charge un fichier PDF dans Elasticsearch.
    ...
    def load_doc_in_es(self, doc_path: str, index_name=None) -> str:
        pass
...
class PDFChat(DoccumentChat):
    """
    Classe pour gérer les interactions avec des documents PDF et un modèle de langage.

    Méthodes:
    _random_index(length): Génère un index aléatoire de longueur spécifiée.
    load_doc_in_es(doc_path, index_name): Charge un fichier PDF dans Elasticsearch.
    """
    ...
    def load_doc_in_es(self, doc_path: str, index_name=None) -> str:
        ...
        Args:
        doc_path (str): Chemin vers le fichier PDF.
        ...
        try:
            ...
            print(
                f"petit souci au chargement du fichier {doc_path}: {e} \n Solutions: \n- Change de nom d'index\n- Vérifier que ElasticSearch tourne correctement")
            return None
        return index_name


class DocxChat(DoccumentChat):
    """
    Classe pour gérer les interactions avec des documents PDF et un modèle de langage.
    ...
    def load_doc_in_es(self, doc_path: str, index_name=None) -> str:
        """
        Charge un fichier Docx dans Elasticsearch.
...
class PptxChat(DoccumentChat):
    ...
    def load_doc_in_es(self, doc_path: str, index_name=None) -> str:
        """
        Charge un fichier Ppt dans Elasticsearch.
